...
const ResultModal = ({ orderId = "", setShowResultModal = () => { }, showResultModal = false, otpResponseText = "", navigation = {} }) => {
    return (
        <Modal
            animationType="slide"
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <View style={styles.textWrapper}>
                        ...
                        <Text style={styles.description}>Product Updated successfully</Text>
                    </View>
