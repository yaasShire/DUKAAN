...
const AddProduct = ({ navigation }) => {
    ...
    tabs.set(1, <MainCategory setCurrentPosition={setCurrentPosition} category={mainCategories} title="Please select a category from list below" />);
    tabs.set(2, <SubCategory setCurrentPosition={setCurrentPosition} category={subCategories} title="Please select a sub category from list below." />);
    tabs.set(3, <ProductCategory setCurrentPosition={setCurrentPosition} category={productCategories} title="Please select a category from list below" />);
