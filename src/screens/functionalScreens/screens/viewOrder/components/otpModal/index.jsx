...
const OTPModal = ({ sendOTP = () => { }, setShowOTPModal = () => { }, showOTPModal = false, setOtpResponseModal = () => { } }) => {
    return (
        <Modal
            animationType="slide"
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <View style={styles.textWrapper}>
                        <Text style={styles.title}>Seller To Agent OTP</Text>
                        <Text style={styles.description}>Send OTP to verify the delivery agent.</Text>
                    </View>
                    <View style={styles.btnsWrapper}>
                        <Pressable style={[styles.btn, styles.btn1]} onPress={() => setShowOTPModal(false)}>
