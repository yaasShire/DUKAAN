...
const UpdatePickerProduct = ({ listData = [], label = "", color = "blue", fieldName = "", category = {}, productId = "", setIsLoading = () => { }, setError = () => { }, fetchTargetProduct = () => { } }) => {
    ...
    const updateCategory = async () => {
        ...
        productData.append(fieldName, Number(selectedValue?.id))
...
export default UpdatePickerProduct